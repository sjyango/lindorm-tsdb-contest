...
static int iunpacksearchwithlength0(__m128i initOffset, const __m128i *_in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  if (length > 0) {
...
static int iunpacksearchwithlength1(__m128i initOffset, const __m128i *in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  int i = 0;
...
static int iunpacksearchwithlength2(__m128i initOffset, const __m128i *in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength3(__m128i initOffset, const __m128i *in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength4(__m128i initOffset, const __m128i *in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength5(__m128i initOffset, const __m128i *in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength6(__m128i initOffset, const __m128i *in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength7(__m128i initOffset, const __m128i *in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength8(__m128i initOffset, const __m128i *in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength9(__m128i initOffset, const __m128i *in,
                                    int length, uint32_t key,
                                    uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength10(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength11(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength12(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength13(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength14(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength15(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength16(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength17(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength18(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength19(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength20(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength21(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength22(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength23(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength24(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength25(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength26(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength27(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength28(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength29(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength30(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength31(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
...
static int iunpacksearchwithlength32(__m128i initOffset, const __m128i *in,
                                     int length, uint32_t key,
                                     uint32_t *presult) {
...
int simdsearchwithlengthd1(uint32_t initvalue, const __m128i *in, uint32_t bit,
  ...
  switch (bit) {
  case 0:
    return iunpacksearchwithlength0(initOffset, in, length, key, presult);

  case 1:
    return iunpacksearchwithlength1(initOffset, in, length, key, presult);

  case 2:
    return iunpacksearchwithlength2(initOffset, in, length, key, presult);

  case 3:
    return iunpacksearchwithlength3(initOffset, in, length, key, presult);

  case 4:
    return iunpacksearchwithlength4(initOffset, in, length, key, presult);

  case 5:
    return iunpacksearchwithlength5(initOffset, in, length, key, presult);

  case 6:
    return iunpacksearchwithlength6(initOffset, in, length, key, presult);

  case 7:
    return iunpacksearchwithlength7(initOffset, in, length, key, presult);

  case 8:
    return iunpacksearchwithlength8(initOffset, in, length, key, presult);

  case 9:
    return iunpacksearchwithlength9(initOffset, in, length, key, presult);

  case 10:
    return iunpacksearchwithlength10(initOffset, in, length, key, presult);

  case 11:
    return iunpacksearchwithlength11(initOffset, in, length, key, presult);

  case 12:
    return iunpacksearchwithlength12(initOffset, in, length, key, presult);

  case 13:
    return iunpacksearchwithlength13(initOffset, in, length, key, presult);

  case 14:
    return iunpacksearchwithlength14(initOffset, in, length, key, presult);

  case 15:
    return iunpacksearchwithlength15(initOffset, in, length, key, presult);

  case 16:
    return iunpacksearchwithlength16(initOffset, in, length, key, presult);

  case 17:
    return iunpacksearchwithlength17(initOffset, in, length, key, presult);

  case 18:
    return iunpacksearchwithlength18(initOffset, in, length, key, presult);

  case 19:
    return iunpacksearchwithlength19(initOffset, in, length, key, presult);

  case 20:
    return iunpacksearchwithlength20(initOffset, in, length, key, presult);

  case 21:
    return iunpacksearchwithlength21(initOffset, in, length, key, presult);

  case 22:
    return iunpacksearchwithlength22(initOffset, in, length, key, presult);

  case 23:
    return iunpacksearchwithlength23(initOffset, in, length, key, presult);

  case 24:
    return iunpacksearchwithlength24(initOffset, in, length, key, presult);

  case 25:
    return iunpacksearchwithlength25(initOffset, in, length, key, presult);

  case 26:
    return iunpacksearchwithlength26(initOffset, in, length, key, presult);

  case 27:
    return iunpacksearchwithlength27(initOffset, in, length, key, presult);

  case 28:
    return iunpacksearchwithlength28(initOffset, in, length, key, presult);

  case 29:
    return iunpacksearchwithlength29(initOffset, in, length, key, presult);

  case 30:
    return iunpacksearchwithlength30(initOffset, in, length, key, presult);

  case 31:
    return iunpacksearchwithlength31(initOffset, in, length, key, presult);

  case 32:
    return iunpacksearchwithlength32(initOffset, in, length, key, presult);
...
static int iunpacksearch0(__m128i *initOffset, const __m128i *_in, uint32_t key,
                          uint32_t *presult) {
  uint32_t repeatedvalue = (uint32_t)_mm_extract_epi32(*initOffset, 3);
  if (repeatedvalue >= key) {
    *presult = repeatedvalue;
...
static int iunpacksearch1(__m128i *initOffset, const __m128i *in, uint32_t key,
                          uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch2(__m128i *initOffset, const __m128i *in, uint32_t key,
                          uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch3(__m128i *initOffset, const __m128i *in, uint32_t key,
                          uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch4(__m128i *initOffset, const __m128i *in, uint32_t key,
                          uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch5(__m128i *initOffset, const __m128i *in, uint32_t key,
                          uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch6(__m128i *initOffset, const __m128i *in, uint32_t key,
                          uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch7(__m128i *initOffset, const __m128i *in, uint32_t key,
                          uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch8(__m128i *initOffset, const __m128i *in, uint32_t key,
                          uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch9(__m128i *initOffset, const __m128i *in, uint32_t key,
                          uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch10(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch11(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch12(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch13(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch14(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch15(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch16(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch17(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch18(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch19(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch20(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch21(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch22(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch23(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch24(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch25(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch26(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch27(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch28(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch29(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch30(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch31(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  int i = 0;
  __m128i InReg = _mm_loadu_si128(in);
  __m128i out;
...
static int iunpacksearch32(__m128i *initOffset, const __m128i *in, uint32_t key,
                           uint32_t *presult) {
  uint32_t *in32 = (uint32_t *)in;
...
int simdsearchd1(__m128i *initOffset, const __m128i *in, uint32_t bit,
  ...
  switch (bit) {
  case 0:
    return iunpacksearch0(initOffset, in, key, presult);

  case 1:
    return iunpacksearch1(initOffset, in, key, presult);

  case 2:
    return iunpacksearch2(initOffset, in, key, presult);

  case 3:
    return iunpacksearch3(initOffset, in, key, presult);

  case 4:
    return iunpacksearch4(initOffset, in, key, presult);

  case 5:
    return iunpacksearch5(initOffset, in, key, presult);

  case 6:
    return iunpacksearch6(initOffset, in, key, presult);

  case 7:
    return iunpacksearch7(initOffset, in, key, presult);

  case 8:
    return iunpacksearch8(initOffset, in, key, presult);

  case 9:
    return iunpacksearch9(initOffset, in, key, presult);

  case 10:
    return iunpacksearch10(initOffset, in, key, presult);

  case 11:
    return iunpacksearch11(initOffset, in, key, presult);

  case 12:
    return iunpacksearch12(initOffset, in, key, presult);

  case 13:
    return iunpacksearch13(initOffset, in, key, presult);

  case 14:
    return iunpacksearch14(initOffset, in, key, presult);

  case 15:
    return iunpacksearch15(initOffset, in, key, presult);

  case 16:
    return iunpacksearch16(initOffset, in, key, presult);

  case 17:
    return iunpacksearch17(initOffset, in, key, presult);

  case 18:
    return iunpacksearch18(initOffset, in, key, presult);

  case 19:
    return iunpacksearch19(initOffset, in, key, presult);

  case 20:
    return iunpacksearch20(initOffset, in, key, presult);

  case 21:
    return iunpacksearch21(initOffset, in, key, presult);

  case 22:
    return iunpacksearch22(initOffset, in, key, presult);

  case 23:
    return iunpacksearch23(initOffset, in, key, presult);

  case 24:
    return iunpacksearch24(initOffset, in, key, presult);

  case 25:
    return iunpacksearch25(initOffset, in, key, presult);

  case 26:
    return iunpacksearch26(initOffset, in, key, presult);

  case 27:
    return iunpacksearch27(initOffset, in, key, presult);

  case 28:
    return iunpacksearch28(initOffset, in, key, presult);

  case 29:
    return iunpacksearch29(initOffset, in, key, presult);

  case 30:
    return iunpacksearch30(initOffset, in, key, presult);

  case 31:
    return iunpacksearch31(initOffset, in, key, presult);

  case 32:
    return iunpacksearch32(initOffset, in, key, presult);
