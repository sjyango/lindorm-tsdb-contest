#include "../include/avx512bitpacking.h"
#ifdef __AVX512F__
...
/* we are going to pack 512 1-bit values, touching 1 512-bit words, using 32
 * bytes */
...
/* we are going to pack 512 2-bit values, touching 2 512-bit words, using 64
 * bytes */
...
/* we are going to pack 512 3-bit values, touching 3 512-bit words, using 96
 * bytes */
...
/* we are going to pack 512 4-bit values, touching 4 512-bit words, using 128
 * bytes */
...
/* we are going to pack 512 5-bit values, touching 5 512-bit words, using 160
 * bytes */
...
/* we are going to pack 512 6-bit values, touching 6 512-bit words, using 192
 * bytes */
...
/* we are going to pack 512 7-bit values, touching 7 512-bit words, using 224
 * bytes */
...
/* we are going to pack 512 8-bit values, touching 8 512-bit words, using 256
 * bytes */
...
/* we are going to pack 512 9-bit values, touching 9 512-bit words, using 288
 * bytes */
...
/* we are going to pack 512 10-bit values, touching 10 512-bit words, using 320
 * bytes */
...
/* we are going to pack 512 11-bit values, touching 11 512-bit words, using 352
 * bytes */
...
/* we are going to pack 512 12-bit values, touching 12 512-bit words, using 384
 * bytes */
...
/* we are going to pack 512 13-bit values, touching 13 512-bit words, using 416
 * bytes */
...
/* we are going to pack 512 14-bit values, touching 14 512-bit words, using 448
 * bytes */
...
/* we are going to pack 512 15-bit values, touching 15 512-bit words, using 480
 * bytes */
...
/* we are going to pack 512 16-bit values, touching 16 512-bit words, using 512
 * bytes */
...
/* we are going to pack 512 17-bit values, touching 17 512-bit words, using 544
 * bytes */
...
/* we are going to pack 512 18-bit values, touching 18 512-bit words, using 576
 * bytes */
...
/* we are going to pack 512 19-bit values, touching 19 512-bit words, using 608
 * bytes */
...
/* we are going to pack 512 20-bit values, touching 20 512-bit words, using 640
 * bytes */
...
/* we are going to pack 512 21-bit values, touching 21 512-bit words, using 672
 * bytes */
...
/* we are going to pack 512 22-bit values, touching 22 512-bit words, using 704
 * bytes */
...
/* we are going to pack 512 23-bit values, touching 23 512-bit words, using 736
 * bytes */
...
/* we are going to pack 512 24-bit values, touching 24 512-bit words, using 768
 * bytes */
...
/* we are going to pack 512 25-bit values, touching 25 512-bit words, using 800
 * bytes */
...
/* we are going to pack 512 26-bit values, touching 26 512-bit words, using 832
 * bytes */
...
/* we are going to pack 512 27-bit values, touching 27 512-bit words, using 864
 * bytes */
...
/* we are going to pack 512 28-bit values, touching 28 512-bit words, using 896
 * bytes */
...
/* we are going to pack 512 29-bit values, touching 29 512-bit words, using 928
 * bytes */
...
/* we are going to pack 512 30-bit values, touching 30 512-bit words, using 960
 * bytes */
...
/* we are going to pack 512 31-bit values, touching 31 512-bit words, using 992
 * bytes */
...
/* we are going to pack 512 32-bit values, touching 32 512-bit words, using 1024
 * bytes */
...
static void avx512packblockmask1(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)), 1));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)), 2));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)), 3));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 4)), 4));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)), 5));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 6)), 6));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)), 7));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 8)), 8));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)), 9));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 10)),
                            10));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 11)),
                            11));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 12)),
                            12));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 13)),
                            13));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 14)),
                            14));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 15)),
                            15));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 16)),
                            16));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 17)),
                            17));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 18)),
                            18));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 19)),
                            19));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 20)),
                            20));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 21)),
                            21));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 22)),
                            22));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 23)),
                            23));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 24)),
                            24));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 25)),
                            25));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 26)),
                            26));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 27)),
                            27));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 28)),
                            28));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 29)),
                            29));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 30)),
                            30));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 31)),
                            31));
  _mm512_storeu_si512(compressed + 0, w0);
}
...
static void avx512packblockmask2(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)), 2));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)), 4));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)), 6));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 4)), 8));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)),
                            10));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 6)),
                            12));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)),
                            14));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 8)),
                            16));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)),
                            18));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 10)),
                            20));
  ...
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 17)),
                            2));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 18)),
                            4));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 19)),
                            6));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 20)),
                            8));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 21)),
                            10));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 22)),
                            12));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 23)),
                            14));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 24)),
                            16));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 25)),
                            18));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 26)),
                            20));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 27)),
                            22));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 28)),
                            24));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 29)),
                            26));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 30)),
                            28));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 31)),
                            30));
  _mm512_storeu_si512(compressed + 1, w1);
}
...
static void avx512packblockmask3(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)), 3));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)), 6));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)), 9));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 4)),
                            12));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)),
                            15));
  ...
  _mm512_storeu_si512(compressed + 0, w0);
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 11)),
                            1));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 12)),
                            4));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 13)),
                            7));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 14)),
                            10));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 15)),
                            13));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 16)),
                            16));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 17)),
                            19));
...
static void avx512packblockmask4(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)), 4));
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)), 8));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)),
                            12));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 4)),
                            16));
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)), 4));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 10)),
                            8));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 11)),
                            12));
...
static void avx512packblockmask5(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)), 5));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)),
                            10));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)),
                            15));
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)), 3));
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 8)), 8));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)),
                            13));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 10)),
                            18));
...
static void avx512packblockmask6(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)), 6));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)),
                            12));
  w0 = _mm512_or_si512(
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 6)), 4));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)),
                            10));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 8)),
                            16));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)),
                            22));
...
static void avx512packblockmask7(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)), 7));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)),
                            14));
  w0 = _mm512_or_si512(
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)), 3));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 6)),
                            10));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)),
                            17));
...
static void avx512packblockmask8(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)), 8));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)),
                            16));
  w0 = _mm512_or_si512(
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)), 8));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 6)),
                            16));
  w1 = _mm512_or_si512(
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)), 8));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 10)),
                            16));
  w0 = _mm512_or_si512(
...
static void avx512packblockmask9(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)), 9));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)),
                            18));
  ...
  w1 = _mm512_or_si512(
      ...
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 4)), 4));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)),
                            13));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 6)),
                            22));
...
static void avx512packblockmask10(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_and_si512(mask, _mm512_loadu_si512(in + 0));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 1)),
                            10));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)),
                            20));
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)), 6));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 8)),
                            16));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 9));
...
static void avx512packblockmask11(const uint32_t *pin, __m512i *compressed) {
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)), 1));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 4)),
                            12));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 5));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 23));
  w0 = _mm512_srli_epi32(tmp, 9);
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 6)), 2));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)),
                            13));
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)), 3));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 10)),
                            14));
...
static void avx512packblockmask12(const uint32_t *pin, __m512i *compressed) {
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)), 4));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 4)),
                            16));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 5));
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 6)), 8));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)),
                            20));
  _mm512_storeu_si512(compressed + 2, w0);
...
static void avx512packblockmask13(const uint32_t *pin, __m512i *compressed) {
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)), 7));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 4));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 20));
  w0 = _mm512_srli_epi32(tmp, 12);
  _mm512_storeu_si512(compressed + 1, w1);
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)), 1));
  w0 = _mm512_or_si512(
      w0, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 6)),
                            14));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 7));
...
static void avx512packblockmask14(const uint32_t *pin, __m512i *compressed) {
  ...
  _mm512_storeu_si512(compressed + 0, w0);
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)),
                            10));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 4));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 24));
  w0 = _mm512_srli_epi32(tmp, 8);
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)), 6));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 6));
  w0 = _mm512_or_si512(w0, _mm512_slli_epi32(tmp, 20));
  w1 = _mm512_srli_epi32(tmp, 12);
  _mm512_storeu_si512(compressed + 2, w0);
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)), 2));
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 8)),
                            16));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 9));
...
static void avx512packblockmask15(const uint32_t *pin, __m512i *compressed) {
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)), 9));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 8));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 24));
  w0 = _mm512_srli_epi32(tmp, 8);
  _mm512_storeu_si512(compressed + 3, w1);
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)), 7));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 10));
  w0 = _mm512_or_si512(w0, _mm512_slli_epi32(tmp, 22));
  w1 = _mm512_srli_epi32(tmp, 10);
  _mm512_storeu_si512(compressed + 4, w0);
...
static void avx512packblockmask18(const uint32_t *pin, __m512i *compressed) {
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)), 2));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 10));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 20));
  w0 = _mm512_srli_epi32(tmp, 12);
  _mm512_storeu_si512(compressed + 5, w1);
...
static void avx512packblockmask19(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)), 5));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 8));
  w0 = _mm512_or_si512(w0, _mm512_slli_epi32(tmp, 24));
  w1 = _mm512_srli_epi32(tmp, 8);
  _mm512_storeu_si512(compressed + 4, w0);
...
static void avx512packblockmask20(const uint32_t *pin, __m512i *compressed) {
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)), 4));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 6));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 24));
  w0 = _mm512_srli_epi32(tmp, 8);
  _mm512_storeu_si512(compressed + 3, w1);
...
static void avx512packblockmask21(const uint32_t *pin, __m512i *compressed) {
  ...
  _mm512_storeu_si512(compressed + 0, w0);
  w1 = _mm512_or_si512(
      w1, _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 2)),
                            10));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 3));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 31));
  w0 = _mm512_srli_epi32(tmp, 1);
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)), 9));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 6));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 30));
  w0 = _mm512_srli_epi32(tmp, 2);
  _mm512_storeu_si512(compressed + 3, w1);
...
static void avx512packblockmask22(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)), 2));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 4));
  w0 = _mm512_or_si512(w0, _mm512_slli_epi32(tmp, 24));
  w1 = _mm512_srli_epi32(tmp, 8);
  _mm512_storeu_si512(compressed + 2, w0);
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)), 6));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 10));
  w0 = _mm512_or_si512(w0, _mm512_slli_epi32(tmp, 28));
  w1 = _mm512_srli_epi32(tmp, 4);
  _mm512_storeu_si512(compressed + 6, w0);
...
static void avx512packblockmask23(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)), 5));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 4));
  w0 = _mm512_or_si512(w0, _mm512_slli_epi32(tmp, 28));
  w1 = _mm512_srli_epi32(tmp, 4);
  _mm512_storeu_si512(compressed + 2, w0);
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)), 1));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 8));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 24));
  w0 = _mm512_srli_epi32(tmp, 8);
  _mm512_storeu_si512(compressed + 5, w1);
...
static void avx512packblockmask24(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 3)), 8));
  _mm512_storeu_si512(compressed + 2, w0);
  w1 = _mm512_and_si512(mask, _mm512_loadu_si512(in + 4));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 5));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 24));
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)), 8));
  _mm512_storeu_si512(compressed + 5, w1);
  w0 = _mm512_and_si512(mask, _mm512_loadu_si512(in + 8));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 9));
  w0 = _mm512_or_si512(w0, _mm512_slli_epi32(tmp, 24));
...
static void avx512packblockmask25(const uint32_t *pin, __m512i *compressed) {
  ...
  w1 = _mm512_or_si512(
      w1,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 9)), 1));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 10));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 26));
  w0 = _mm512_srli_epi32(tmp, 6);
  _mm512_storeu_si512(compressed + 7, w1);
...
static void avx512packblockmask26(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 5)), 2));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 6));
  w0 = _mm512_or_si512(w0, _mm512_slli_epi32(tmp, 28));
  w1 = _mm512_srli_epi32(tmp, 4);
  _mm512_storeu_si512(compressed + 4, w0);
...
static void avx512packblockmask28(const uint32_t *pin, __m512i *compressed) {
  ...
  w0 = _mm512_or_si512(
      w0,
      _mm512_slli_epi32(_mm512_and_si512(mask, _mm512_loadu_si512(in + 7)), 4));
  _mm512_storeu_si512(compressed + 6, w0);
  w1 = _mm512_and_si512(mask, _mm512_loadu_si512(in + 8));
  tmp = _mm512_and_si512(mask, _mm512_loadu_si512(in + 9));
  w1 = _mm512_or_si512(w1, _mm512_slli_epi32(tmp, 28));
...
static void avx512unpackblock1(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(out + 1,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 1)));
  _mm512_storeu_si512(out + 2,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 2)));
  _mm512_storeu_si512(out + 3,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 3)));
  _mm512_storeu_si512(out + 4,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 4)));
  _mm512_storeu_si512(out + 5,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 5)));
  _mm512_storeu_si512(out + 6,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 6)));
  _mm512_storeu_si512(out + 7,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 7)));
  _mm512_storeu_si512(out + 8,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 8)));
  _mm512_storeu_si512(out + 9,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 9)));
  _mm512_storeu_si512(out + 10,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 10)));
  _mm512_storeu_si512(out + 11,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 11)));
  _mm512_storeu_si512(out + 12,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 12)));
  _mm512_storeu_si512(out + 13,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 13)));
  _mm512_storeu_si512(out + 14,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 14)));
  _mm512_storeu_si512(out + 15,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 15)));
  _mm512_storeu_si512(out + 16,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 16)));
  _mm512_storeu_si512(out + 17,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 17)));
  _mm512_storeu_si512(out + 18,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 18)));
  _mm512_storeu_si512(out + 19,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 19)));
  _mm512_storeu_si512(out + 20,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 20)));
  _mm512_storeu_si512(out + 21,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 21)));
  _mm512_storeu_si512(out + 22,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 22)));
  _mm512_storeu_si512(out + 23,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 23)));
  _mm512_storeu_si512(out + 24,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 24)));
  _mm512_storeu_si512(out + 25,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 25)));
  _mm512_storeu_si512(out + 26,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 26)));
  _mm512_storeu_si512(out + 27,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 27)));
  _mm512_storeu_si512(out + 28,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 28)));
  _mm512_storeu_si512(out + 29,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 29)));
  _mm512_storeu_si512(out + 30,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w0, 30)));
...
static void avx512unpackblock2(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(out + 17,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 2)));
  _mm512_storeu_si512(out + 18,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 4)));
  _mm512_storeu_si512(out + 19,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 6)));
  _mm512_storeu_si512(out + 20,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 8)));
  _mm512_storeu_si512(out + 21,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 10)));
  _mm512_storeu_si512(out + 22,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 12)));
  _mm512_storeu_si512(out + 23,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 14)));
  _mm512_storeu_si512(out + 24,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 16)));
  _mm512_storeu_si512(out + 25,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 18)));
  _mm512_storeu_si512(out + 26,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 20)));
  _mm512_storeu_si512(out + 27,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 22)));
  _mm512_storeu_si512(out + 28,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 24)));
  _mm512_storeu_si512(out + 29,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 26)));
  _mm512_storeu_si512(out + 30,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 28)));
...
static void avx512unpackblock3(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(out + 11,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 1)));
  _mm512_storeu_si512(out + 12,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 4)));
  _mm512_storeu_si512(out + 13,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 7)));
  _mm512_storeu_si512(out + 14,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 10)));
  _mm512_storeu_si512(out + 15,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 13)));
  _mm512_storeu_si512(out + 16,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 16)));
  _mm512_storeu_si512(out + 17,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 19)));
  _mm512_storeu_si512(out + 18,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 22)));
  _mm512_storeu_si512(out + 19,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 25)));
  _mm512_storeu_si512(out + 20,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 28)));
...
static void avx512unpackblock5(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      ...
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 30),
                                             _mm512_slli_epi32(w1, 2))));
  _mm512_storeu_si512(out + 7,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 3)));
  _mm512_storeu_si512(out + 8,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 8)));
  _mm512_storeu_si512(out + 9,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 13)));
  _mm512_storeu_si512(out + 10,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 18)));
  _mm512_storeu_si512(out + 11,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 23)));
  w0 = _mm512_loadu_si512(compressed + 2);
  _mm512_storeu_si512(
      out + 12,
  ...
  _mm512_storeu_si512(out + 20,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 4)));
  _mm512_storeu_si512(out + 21,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 9)));
  _mm512_storeu_si512(out + 22,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 14)));
  _mm512_storeu_si512(out + 23,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 19)));
...
static void avx512unpackblock7(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(out + 6,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 10)));
  _mm512_storeu_si512(out + 7,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 17)));
  _mm512_storeu_si512(out + 8,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 24)));
  w0 = _mm512_loadu_si512(compressed + 2);
  _mm512_storeu_si512(
  ...
  _mm512_storeu_si512(out + 24,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 8)));
  _mm512_storeu_si512(out + 25,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 15)));
  _mm512_storeu_si512(out + 26,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 22)));
...
static void avx512unpackblock9(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(out + 12,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 12)));
  _mm512_storeu_si512(out + 13,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 21)));
  w0 = _mm512_loadu_si512(compressed + 4);
  _mm512_storeu_si512(
      out + 14,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 30),
  ...
  _mm512_storeu_si512(out + 18,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 2)));
  _mm512_storeu_si512(out + 19,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 11)));
  _mm512_storeu_si512(out + 20,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 20)));
  w0 = _mm512_loadu_si512(compressed + 6);
  _mm512_storeu_si512(
...
static void avx512unpackblock11(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 2,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 22),
  ...
  _mm512_storeu_si512(
      ...
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 26),
                                             _mm512_slli_epi32(w1, 6))));
  _mm512_storeu_si512(out + 15,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 5)));
  _mm512_storeu_si512(out + 16,
                      _mm512_and_si512(mask, _mm512_srli_epi32(w1, 16)));
  w0 = _mm512_loadu_si512(compressed + 6);
  _mm512_storeu_si512(
...
static void avx512unpackblock13(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 4,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 20),
  ...
  _mm512_storeu_si512(
      out + 9,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 21),
  ...
  _mm512_storeu_si512(
      out + 14,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 22),
...
static void avx512unpackblock14(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 6,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 20),
...
static void avx512unpackblock15(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 14,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 18),
  ...
  _mm512_storeu_si512(
      out + 27,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 21),
  ...
  _mm512_storeu_si512(
      out + 29,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 19),
...
static void avx512unpackblock17(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 1,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 17),
  ...
  _mm512_storeu_si512(
      out + 16,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 16),
  ...
  _mm512_storeu_si512(
      out + 18,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 18),
...
static void avx512unpackblock18(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 24,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 16),
...
static void avx512unpackblock19(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 1,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 19),
  ...
  _mm512_storeu_si512(
      out + 21,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 15),
  ...
  _mm512_storeu_si512(
      out + 26,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 14),
...
static void avx512unpackblock21(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 22,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 14),
  ...
  _mm512_storeu_si512(
      out + 25,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 13),
  ...
  _mm512_storeu_si512(
      out + 28,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 12),
...
static void avx512unpackblock22(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 2,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 12),
...
static void avx512unpackblock23(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 6,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 10),
  ...
  _mm512_storeu_si512(
      out + 13,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 11),
  ...
  _mm512_storeu_si512(
      out + 27,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 13),
...
static void avx512unpackblock25(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 3,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 11),
  ...
  _mm512_storeu_si512(
      out + 7,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 15),
                                             _mm512_slli_epi32(w0, 17))));
  w1 = _mm512_loadu_si512(compressed + 7);
  _mm512_storeu_si512(
      out + 8,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 8),
  ...
  _mm512_storeu_si512(
      out + 17,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 9),
  ...
  _mm512_storeu_si512(
      out + 25,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 17),
...
static void avx512unpackblock26(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 4,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 8),
  ...
  _mm512_storeu_si512(
      out + 9,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 10),
...
static void avx512unpackblock27(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 5,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 7),
  ...
  _mm512_storeu_si512(
      out + 18,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 6),
...
static void avx512unpackblock29(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 9,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 5),
  ...
  _mm512_storeu_si512(
      out + 19,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 7),
                                             _mm512_slli_epi32(w0, 25))));
  w1 = _mm512_loadu_si512(compressed + 19);
  _mm512_storeu_si512(
      out + 20,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 4),
  ...
  _mm512_storeu_si512(
      out + 29,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 9),
...
static void avx512unpackblock30(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 13,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 6),
                                             _mm512_slli_epi32(w1, 26))));
  w0 = _mm512_loadu_si512(compressed + 14);
  _mm512_storeu_si512(
      out + 14,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 4),
...
static void avx512unpackblock31(const __m512i *compressed, uint32_t *pout) {
  ...
  _mm512_storeu_si512(
      out + 29,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w0, 3),
                                             _mm512_slli_epi32(w1, 29))));
  w0 = _mm512_loadu_si512(compressed + 30);
  _mm512_storeu_si512(
      out + 30,
      _mm512_and_si512(mask, _mm512_or_si512(_mm512_srli_epi32(w1, 2),
...
/* reads 512 values from "in", writes  "bit" 512-bit vectors to "out" */
void avx512packwithoutmask(const uint32_t *in, __m512i *out,
                           const uint32_t bit) {
