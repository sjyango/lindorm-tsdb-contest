#include "../include/avxbitpacking.h"
#ifdef __AVX2__
...
/* we are going to pack 256 1-bit values, touching 1 256-bit words, using 16
 * bytes */
...
/* we are going to pack 256 2-bit values, touching 2 256-bit words, using 32
 * bytes */
...
/* we are going to pack 256 3-bit values, touching 3 256-bit words, using 48
 * bytes */
...
/* we are going to pack 256 4-bit values, touching 4 256-bit words, using 64
 * bytes */
...
/* we are going to pack 256 5-bit values, touching 5 256-bit words, using 80
 * bytes */
...
/* we are going to pack 256 7-bit values, touching 7 256-bit words, using 112
 * bytes */
...
/* we are going to pack 256 8-bit values, touching 8 256-bit words, using 128
 * bytes */
...
/* we are going to pack 256 9-bit values, touching 9 256-bit words, using 144
 * bytes */
...
/* we are going to pack 256 10-bit values, touching 10 256-bit words, using 160
 * bytes */
...
/* we are going to pack 256 11-bit values, touching 11 256-bit words, using 176
 * bytes */
...
/* we are going to pack 256 12-bit values, touching 12 256-bit words, using 192
 * bytes */
...
/* we are going to pack 256 13-bit values, touching 13 256-bit words, using 208
 * bytes */
...
/* we are going to pack 256 14-bit values, touching 14 256-bit words, using 224
 * bytes */
...
/* we are going to pack 256 15-bit values, touching 15 256-bit words, using 240
 * bytes */
...
/* we are going to pack 256 16-bit values, touching 16 256-bit words, using 256
 * bytes */
...
/* we are going to pack 256 17-bit values, touching 17 256-bit words, using 272
 * bytes */
...
/* we are going to pack 256 18-bit values, touching 18 256-bit words, using 288
 * bytes */
...
/* we are going to pack 256 19-bit values, touching 19 256-bit words, using 304
 * bytes */
...
/* we are going to pack 256 20-bit values, touching 20 256-bit words, using 320
 * bytes */
...
/* we are going to pack 256 21-bit values, touching 21 256-bit words, using 336
 * bytes */
...
/* we are going to pack 256 22-bit values, touching 22 256-bit words, using 352
 * bytes */
...
/* we are going to pack 256 23-bit values, touching 23 256-bit words, using 368
 * bytes */
...
/* we are going to pack 256 24-bit values, touching 24 256-bit words, using 384
 * bytes */
...
/* we are going to pack 256 25-bit values, touching 25 256-bit words, using 400
 * bytes */
...
/* we are going to pack 256 26-bit values, touching 26 256-bit words, using 416
 * bytes */
...
/* we are going to pack 256 27-bit values, touching 27 256-bit words, using 432
 * bytes */
...
/* we are going to pack 256 28-bit values, touching 28 256-bit words, using 448
 * bytes */
...
/* we are going to pack 256 29-bit values, touching 29 256-bit words, using 464
 * bytes */
...
/* we are going to pack 256 30-bit values, touching 30 256-bit words, using 480
 * bytes */
...
/* we are going to pack 256 31-bit values, touching 31 256-bit words, using 496
 * bytes */
...
/* we are going to pack 256 32-bit values, touching 32 256-bit words, using 512
 * bytes */
...
static void avxpackblockmask1(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)), 1));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)), 2));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)), 3));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 4)), 4));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)), 5));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 6)), 6));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)), 7));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 8)), 8));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)), 9));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 10)),
                            10));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 11)),
                            11));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 12)),
                            12));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 13)),
                            13));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 14)),
                            14));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 15)),
                            15));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 16)),
                            16));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 17)),
                            17));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 18)),
                            18));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 19)),
                            19));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 20)),
                            20));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 21)),
                            21));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 22)),
                            22));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 23)),
                            23));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 24)),
                            24));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 25)),
                            25));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 26)),
                            26));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 27)),
                            27));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 28)),
                            28));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 29)),
                            29));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 30)),
                            30));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 31)),
                            31));
  _mm256_storeu_si256(compressed + 0, w0);
}
...
static void avxpackblockmask2(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)), 2));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)), 4));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)), 6));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 4)), 8));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)),
                            10));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 6)),
                            12));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)),
                            14));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 8)),
                            16));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)),
                            18));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 10)),
                            20));
  ...
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 17)),
                            2));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 18)),
                            4));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 19)),
                            6));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 20)),
                            8));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 21)),
                            10));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 22)),
                            12));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 23)),
                            14));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 24)),
                            16));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 25)),
                            18));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 26)),
                            20));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 27)),
                            22));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 28)),
                            24));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 29)),
                            26));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 30)),
                            28));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 31)),
                            30));
  _mm256_storeu_si256(compressed + 1, w1);
}
...
static void avxpackblockmask3(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)), 3));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)), 6));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)), 9));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 4)),
                            12));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)),
                            15));
  ...
  _mm256_storeu_si256(compressed + 0, w0);
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 11)),
                            1));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 12)),
                            4));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 13)),
                            7));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 14)),
                            10));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 15)),
                            13));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 16)),
                            16));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 17)),
                            19));
...
static void avxpackblockmask4(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)), 4));
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)), 8));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)),
                            12));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 4)),
                            16));
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)), 4));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 10)),
                            8));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 11)),
                            12));
...
static void avxpackblockmask5(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)), 5));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)),
                            10));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)),
                            15));
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)), 3));
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 8)), 8));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)),
                            13));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 10)),
                            18));
...
static void avxpackblockmask6(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)), 6));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)),
                            12));
  w0 = _mm256_or_si256(
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 6)), 4));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)),
                            10));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 8)),
                            16));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)),
                            22));
...
static void avxpackblockmask7(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)), 7));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)),
                            14));
  w0 = _mm256_or_si256(
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)), 3));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 6)),
                            10));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)),
                            17));
...
static void avxpackblockmask8(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)), 8));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)),
                            16));
  w0 = _mm256_or_si256(
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)), 8));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 6)),
                            16));
  w1 = _mm256_or_si256(
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)), 8));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 10)),
                            16));
  w0 = _mm256_or_si256(
...
static void avxpackblockmask9(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)), 9));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)),
                            18));
  ...
  w1 = _mm256_or_si256(
      ...
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 4)), 4));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)),
                            13));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 6)),
                            22));
...
static void avxpackblockmask10(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 0));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 1)),
                            10));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)),
                            20));
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)), 6));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 8)),
                            16));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 9));
...
static void avxpackblockmask11(const uint32_t *pin, __m256i *compressed) {
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)), 1));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 4)),
                            12));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 5));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 23));
  w0 = _mm256_srli_epi32(tmp, 9);
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 6)), 2));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)),
                            13));
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)), 3));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 10)),
                            14));
...
static void avxpackblockmask12(const uint32_t *pin, __m256i *compressed) {
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)), 4));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 4)),
                            16));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 5));
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 6)), 8));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)),
                            20));
  _mm256_storeu_si256(compressed + 2, w0);
...
static void avxpackblockmask13(const uint32_t *pin, __m256i *compressed) {
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)), 7));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 4));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 20));
  w0 = _mm256_srli_epi32(tmp, 12);
  _mm256_storeu_si256(compressed + 1, w1);
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)), 1));
  w0 = _mm256_or_si256(
      w0, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 6)),
                            14));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 7));
...
static void avxpackblockmask14(const uint32_t *pin, __m256i *compressed) {
  ...
  _mm256_storeu_si256(compressed + 0, w0);
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)),
                            10));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 4));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 24));
  w0 = _mm256_srli_epi32(tmp, 8);
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)), 6));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 6));
  w0 = _mm256_or_si256(w0, _mm256_slli_epi32(tmp, 20));
  w1 = _mm256_srli_epi32(tmp, 12);
  _mm256_storeu_si256(compressed + 2, w0);
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)), 2));
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 8)),
                            16));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 9));
...
static void avxpackblockmask15(const uint32_t *pin, __m256i *compressed) {
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)), 9));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 8));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 24));
  w0 = _mm256_srli_epi32(tmp, 8);
  _mm256_storeu_si256(compressed + 3, w1);
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)), 7));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 10));
  w0 = _mm256_or_si256(w0, _mm256_slli_epi32(tmp, 22));
  w1 = _mm256_srli_epi32(tmp, 10);
  _mm256_storeu_si256(compressed + 4, w0);
...
static void avxpackblockmask18(const uint32_t *pin, __m256i *compressed) {
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)), 2));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 10));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 20));
  w0 = _mm256_srli_epi32(tmp, 12);
  _mm256_storeu_si256(compressed + 5, w1);
...
static void avxpackblockmask19(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)), 5));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 8));
  w0 = _mm256_or_si256(w0, _mm256_slli_epi32(tmp, 24));
  w1 = _mm256_srli_epi32(tmp, 8);
  _mm256_storeu_si256(compressed + 4, w0);
...
static void avxpackblockmask20(const uint32_t *pin, __m256i *compressed) {
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)), 4));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 6));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 24));
  w0 = _mm256_srli_epi32(tmp, 8);
  _mm256_storeu_si256(compressed + 3, w1);
...
static void avxpackblockmask21(const uint32_t *pin, __m256i *compressed) {
  ...
  _mm256_storeu_si256(compressed + 0, w0);
  w1 = _mm256_or_si256(
      w1, _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 2)),
                            10));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 3));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 31));
  w0 = _mm256_srli_epi32(tmp, 1);
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)), 9));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 6));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 30));
  w0 = _mm256_srli_epi32(tmp, 2);
  _mm256_storeu_si256(compressed + 3, w1);
...
static void avxpackblockmask22(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)), 2));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 4));
  w0 = _mm256_or_si256(w0, _mm256_slli_epi32(tmp, 24));
  w1 = _mm256_srli_epi32(tmp, 8);
  _mm256_storeu_si256(compressed + 2, w0);
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)), 6));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 10));
  w0 = _mm256_or_si256(w0, _mm256_slli_epi32(tmp, 28));
  w1 = _mm256_srli_epi32(tmp, 4);
  _mm256_storeu_si256(compressed + 6, w0);
...
static void avxpackblockmask23(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)), 5));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 4));
  w0 = _mm256_or_si256(w0, _mm256_slli_epi32(tmp, 28));
  w1 = _mm256_srli_epi32(tmp, 4);
  _mm256_storeu_si256(compressed + 2, w0);
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)), 1));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 8));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 24));
  w0 = _mm256_srli_epi32(tmp, 8);
  _mm256_storeu_si256(compressed + 5, w1);
...
static void avxpackblockmask24(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 3)), 8));
  _mm256_storeu_si256(compressed + 2, w0);
  w1 = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 4));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 5));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 24));
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)), 8));
  _mm256_storeu_si256(compressed + 5, w1);
  w0 = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 8));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 9));
  w0 = _mm256_or_si256(w0, _mm256_slli_epi32(tmp, 24));
...
static void avxpackblockmask25(const uint32_t *pin, __m256i *compressed) {
  ...
  w1 = _mm256_or_si256(
      w1,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 9)), 1));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 10));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 26));
  w0 = _mm256_srli_epi32(tmp, 6);
  _mm256_storeu_si256(compressed + 7, w1);
...
static void avxpackblockmask26(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 5)), 2));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 6));
  w0 = _mm256_or_si256(w0, _mm256_slli_epi32(tmp, 28));
  w1 = _mm256_srli_epi32(tmp, 4);
  _mm256_storeu_si256(compressed + 4, w0);
...
static void avxpackblockmask28(const uint32_t *pin, __m256i *compressed) {
  ...
  w0 = _mm256_or_si256(
      w0,
      _mm256_slli_epi32(_mm256_and_si256(mask, _mm256_lddqu_si256(in + 7)), 4));
  _mm256_storeu_si256(compressed + 6, w0);
  w1 = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 8));
  tmp = _mm256_and_si256(mask, _mm256_lddqu_si256(in + 9));
  w1 = _mm256_or_si256(w1, _mm256_slli_epi32(tmp, 28));
